...
int encrypt_pw(uint8_t *out_ciphertext,uint8_t *plaintext, size_t size,
    ...
    // 5.AES symmetric encrypt_message
...
int decrypt_pw(uint8_t *out_plaintext,uint8_t *ciphertext, size_t size,
	...
	print(mac,TAKS_MAC_LEN,"        DECRYPT - RECEIVED MAC: ");
	...
	print(computed_mac,TAKS_MAC_LEN,"        DECRYPT - COMPUTED MAC: ");	
	printf("\n computed mac:");
...
#else
#error "Don't know how to encrypt_message"
#endif
}
